...
public class tuesdaytime extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
            ...
            setContentView(R.layout.activity_tuesdaytime);
            ...
            final SharedPreferences getshared1 = getSharedPreferences("tuetime1",MODE_PRIVATE);
            final String value1 = getshared1.getString("str1","0");
            final SharedPreferences getshared2 = getSharedPreferences("tuetime2",MODE_PRIVATE);
            final String value2 = getshared2.getString("str2","0");
            final SharedPreferences getshared3 = getSharedPreferences("tuetime3",MODE_PRIVATE);
            ...
            button.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    SharedPreferences getshared1 = getSharedPreferences("tuetime1",MODE_PRIVATE);
            ...
            button2.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {
                    SharedPreferences getshared2 = getSharedPreferences("tuetime2",MODE_PRIVATE);
            ...
            button3.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {
                    SharedPreferences getshared3 = getSharedPreferences("tuetime3",MODE_PRIVATE);
