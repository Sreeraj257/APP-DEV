...
public class sundaytime extends AppCompatActivity {
    TextView textView;
    Button button;
    Context context;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_sundaytime);
        ...
        final SharedPreferences getshared1 = getSharedPreferences("suntime1",MODE_PRIVATE);
        final String value1 = getshared1.getString("str1","0");
        final SharedPreferences getshared2 = getSharedPreferences("suntime2",MODE_PRIVATE);
        final String value2 = getshared2.getString("str2","0");
        final SharedPreferences getshared3 = getSharedPreferences("suntime3",MODE_PRIVATE);
        ...
        button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                SharedPreferences getshared1 = getSharedPreferences("suntime1",MODE_PRIVATE);
                ...
                if(value1.equals("0")) {
                    ...
                    TimePickerDialog timePickerDialog = new TimePickerDialog(context, new TimePickerDialog.OnTimeSetListener() {
                        ...
                        public void onTimeSet(TimePicker view, int hourOfDay, int minute) {
                            ...
                            SharedPreferences shrd = getSharedPreferences("suntime1", MODE_PRIVATE);
        ...
        button2.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                SharedPreferences getshared2 = getSharedPreferences("suntime2",MODE_PRIVATE);
                ...
                if(value2.equals("0")) {
                    ...
                    TimePickerDialog timePickerDialog = new TimePickerDialog(context, new TimePickerDialog.OnTimeSetListener() {
                        ...
                        public void onTimeSet(TimePicker view, int hourOfDay, int minute) {
                            ...
                            SharedPreferences shrd = getSharedPreferences("suntime2", MODE_PRIVATE);
                            SharedPreferences.Editor editor = shrd.edit();
        ...
        button3.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                SharedPreferences getshared3 = getSharedPreferences("suntime3",MODE_PRIVATE);
                ...
                if(value3.equals("0")) {
                    ...
                    TimePickerDialog timePickerDialog = new TimePickerDialog(context, new TimePickerDialog.OnTimeSetListener() {
                        ...
                        public void onTimeSet(TimePicker view, int hourOfDay, int minute) {
                            ...
                            SharedPreferences shrd = getSharedPreferences("suntime3", MODE_PRIVATE);
                            SharedPreferences.Editor editor = shrd.edit();
