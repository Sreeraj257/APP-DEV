...
public class disease extends AppCompatActivity { TextView head ;
...
//        String gender = getIntent().getStringExtra("gender");
      ...
      //  head.setText(gender+" "+name+" you may have...");
        SharedPreferences getshared2 = getSharedPreferences("logname1",MODE_PRIVATE);
        ...
        head.setText(value2+" "+value1+" you may have...");
